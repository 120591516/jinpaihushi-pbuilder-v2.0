...
public class UserTabCols extends BaseModel{
    ...
    /** @column C is maximum length given in characters, B if in bytes */
	...
	/**
	 * 获取C is maximum length given in characters, B if in bytes
	 */
	...
	/**
	 * 设置C is maximum length given in characters, B if in bytes
	 */
    ...
    public String toString() {
		return new StringBuilder().append("UserTabCols{").
    ...
    /**
	 * 比较字段：
	 * tableName, columnName, dataType, dataTypeMod, dataTypeOwner,
	 * dataLength, dataPrecision, dataScale, nullable, columnId,
	 * defaultLength, dataDefault, numDistinct, lowValue, highValue,
	 * density, numNulls, numBuckets, lastAnalyzed, sampleSize,
	 * characterSetName, charColDeclLength, globalStats, userStats, avgColLen,
	 * charLength, charUsed, v80FmtImage, dataUpgraded, hiddenColumn,
	 * virtualColumn, segmentColumnId, internalColumnId, histogram, qualifiedColName
	 */
	public boolean equals(Object o){
		if(!(o instanceof UserTabCols)) return false;
		UserTabCols v = (UserTabCols)o;
	 ...
	 * virtualColumn, segmentColumnId, internalColumnId, histogram, qualifiedColName
	 */
	public UserTabCols copy(){
		UserTabCols m = new UserTabCols();
