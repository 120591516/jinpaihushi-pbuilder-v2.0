...
public class DbaTabColumns extends BaseModel{
    ...
    public String toString() {
		return new StringBuilder().append("DbaTabColumns{").
	...
	public boolean equals(Object o){
		if(!(o instanceof DbaTabColumns)) return false;
		DbaTabColumns v = (DbaTabColumns)o;
	 ...
	 * histogram
	 */
	public DbaTabColumns copy(){
		DbaTabColumns m = new DbaTabColumns();
     	m.owner = owner;
