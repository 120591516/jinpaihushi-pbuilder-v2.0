...
public class DbaTables extends BaseModel{
	

    /** @column Owner of the table */
...
VALID otherwise
    ...
    public String toString() {
		return new StringBuilder().append("DbaTables{").
    ...
    /**
	 * 比较字段：
	 * owner, tableName, tablespaceName, clusterName, iotName,
	 * status, pctFree, pctUsed, iniTrans, maxTrans,
	 * initialExtent, nextExtent, minExtents, maxExtents, pctIncrease,
	 * freelists, freelistGroups, logging, backedUp, numRows,
	 * blocks, emptyBlocks, avgSpace, chainCnt, avgRowLen,
	 * avgSpaceFreelistBlocks, numFreelistBlocks, degree, instances, cache,
	 * tableLock, sampleSize, lastAnalyzed, partitioned, iotType,
	 * temporary, secondary, nested, bufferPool, rowMovement,
	 * globalStats, userStats, duration, skipCorrupt, monitoring,
	 * clusterOwner, dependencies, compression, dropped
	 */
	public boolean equals(Object o){
		if(!(o instanceof DbaTables)) return false;
		DbaTables v = (DbaTables)o;
	 ...
	 * clusterOwner, dependencies, compression, dropped
	 */
	public DbaTables copy(){
		DbaTables m = new DbaTables();
     	m.owner = owner;
