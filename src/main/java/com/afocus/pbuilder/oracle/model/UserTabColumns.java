...
public class UserTabColumns extends BaseModel{
    ...
    public String toString() {
		return new StringBuilder().append("UserTabColumns{").
	 ...
	 * charLength, charUsed, v80FmtImage, dataUpgraded, histogram
	 */
	public boolean equals(Object o){
		if(!(o instanceof UserTabColumns)) return false;
		UserTabColumns v = (UserTabColumns)o;
	 ...
	 * charLength, charUsed, v80FmtImage, dataUpgraded, histogram
	 */
	public UserTabColumns copy(){
		UserTabColumns m = new UserTabColumns();
