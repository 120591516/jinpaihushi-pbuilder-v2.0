...
public class DbaViews extends BaseModel{
	

    /** @column Owner of the view */
    ...
    /** @column Owner of the type of the view if the view is an object view */
	private String viewTypeOwner;

    /** @column Type of the view if the view is an object view */
	...
	/**
	 * 获取Owner of the type of the view if the view is an object view
	 */
	...
	/**
	 * 设置Owner of the type of the view if the view is an object view
	 */
	...
	/**
	 * 获取Type of the view if the view is an object view
	 */
	...
	/**
	 * 设置Type of the view if the view is an object view
	 */
    ...
    public String toString() {
		return new StringBuilder().append("DbaViews{").
    ...
    /**
	 * 比较字段：
	 * owner, viewName, textLength, text, typeTextLength,
	 * typeText, oidTextLength, oidText, viewTypeOwner, viewType,
	 * superviewName
	 */
	public boolean equals(Object o){
		if(!(o instanceof DbaViews)) return false;
		DbaViews v = (DbaViews)o;
		return (owner==null && v.owner==null || owner != null && owner.equals(v.owner))
			&& (viewName==null && v.viewName==null || viewName != null && viewName.equals(v.viewName))
	 ...
	 * superviewName
	 */
	public DbaViews copy(){
		DbaViews m = new DbaViews();
     	m.owner = owner;
     	m.viewName = viewName;
